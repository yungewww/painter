...
# STROKE_DIM = 9:
#   x/W, y/H, pressure, brush_size/max(W,H), angle_norm, r, g, b, label_id/14
STROKE_DIM  = 9
LABEL_MAX   = 14
...
BASE_CKPT = "model_fm_v3.1.pt"
CKPT      = "model_fm_v3.1.pt"
...
def encode_stroke(s, W, H):
    ...
    return [x_norm, y_norm, press, bs_norm, ang_norm, r, g, b, label_norm]
