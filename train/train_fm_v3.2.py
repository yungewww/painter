...
# STROKE_DIM = 12:
#   x/W, y/H, pressure, brush_size/max(W,H), angle_norm, r, g, b, label_id/14, nx, ny, nz
STROKE_DIM  = 12
LABEL_MAX   = 14
...
BASE_CKPT = "model_fm_v3.2.pt"
CKPT      = "model_fm_v3.2.pt"
...
def encode_stroke(s, W, H):
    ...
    ny = (ny + 1) / 2
    nz = (nz + 1) / 2
    return [x_norm, y_norm, press, bs_norm, ang_norm, r, g, b, label_norm, nx, ny, nz]
